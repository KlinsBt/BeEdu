	...
	<nav class="{navbar}">
        ...
        <div class="nav-container-middle">
            <ul id="nav-list">
                ...
                <li><a href="/en/courses">BE Courses</a></li>
                <li><a href="/en/corporate">Corporate Clients</a>
                  <ul class="dropdown">
                    <li><a href="/en/coming-soon">Translation</a></li>
                    <li><a href="/en/coming-soon">Interpretation</a></li>
    ...
    {#if menuDiv == "ms-open"}
      <section transition:slide={{duration: 300}} class="{menuDiv} {menuDivSticky}">
        <ul id={col} transition:slide={{duration: 300}}>
          <li><a href="/en/">Home</a></li>
          <li><a href="/en/courses">BE Courses</a></li>
          <li><a href="/en/corporate">Corporate Clients</a></li>
          <div class="dropdown-corporate-clients">
            <a href="/en/coming-soon">Translation</a>
