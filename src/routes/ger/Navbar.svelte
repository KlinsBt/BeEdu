...
const languages = [
  {name: "GER", flag: "../img/flags/ger.png", link: "/ger", id: 0},
  {name: "ENG", flag: "../img/flags/us.png", link: "/en", id: 1},
	...
	<nav class="{navbar}">
        ...
        <div class="nav-container-middle">
            <ul id="nav-list">
                ...
                <li><a href="/ger/courses">BE-Kurse</a></li>
                <li><a href="/ger/corporate">Firmenkunden</a>
                  <ul class="dropdown">
                    <li><a href="/ger/coming-soon">Übersetzung</a></li>
                    <li><a href="/ger/coming-soon">Dolmetschen</a></li>
    ...
    {#if menuDiv == "ms-open"}
      <section transition:slide={{duration: 300}} class="{menuDiv} {menuDivSticky}">
        <ul id={col} transition:slide={{duration: 300}}>
          <li><a href="/ger/">Home</a></li>
          <li><a href="/ger/courses">BE-Kurse</a></li>
          <li><a href="/ger/corporate">Firmenkunden</a></li>
          <div class="dropdown-corporate-clients">
            <a href="/ger/coming-soon">Übersetzung</a>
