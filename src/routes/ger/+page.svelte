    ...
    <main>
        ...
        <section class="sec-1">
            ...
            <div class="landing-page-info">
              <div>
                <h2>BILDUNG ÖFFNET TÜREN</h2>
              </div>
              <div><img id="main-logo" src="./img/icons/Wordpress Transparent.png" alt="Main Logo"></div>
                <h3 id="descr-1">Mit Berndt Education denken Sie weiter und besser voraus</h3>
                <p id="descr-2">
                    Berndt Education bietet personalisierte Sprachkurse für Unternehmen und Privatpersonen an, 
                    indem wir die idealen Bedingungen schaffen, damit Sie Ihre gewünschte Sprache so schnell 
                    und effektiv wie möglich lernen. Professionelle Dozenten erstellen ein Sprachprogramm, 
                    das zu Ihrer Work-Life-Balance passt und Sie nach jeder Sitzung informierter als zuvor zurücklässt.
                </p>
            </div>
        ...
        <section class="sub-section">
            <div class="information">
                <h2>AKTIVES LERNSYSTEM</h2>
                <h3 id="sub1">Für erfolgreiches Lernen</h3>
                <p>
                    Mit Berndt Education profitieren Sie oder Ihr Unternehmen von einem ansprechenden Lernkonzept, 
                    das die Vernetzung über Medien in Verbindung mit klassischen Lernmethoden nutzt. Die BE-Dozenten 
                    sind spezialisiert auf neurolinguistische Strategien spezialisiert, um Ihr Lernerlebnis immersiv 
                    und das Behalten des Stoffes dauerhaft zu gestalten.
                </p>
            </div>
            ...
            <div class="info-container">
                <div class="info">
                    ...
                    <div>
                      ...
                      <p class="subtext">
                        Die Dozenten gestalten das individuelle Programm nach einem Beratungsgespräch, in dem die Ziele, der Zeitplan und die 
                        Lernmaterialien festgelegt werden.
                      </p>
                    </div>
                </div>
                <div class="info">
                  ...
                  <div>
                    <h3>SELBSTÄNDIGES LERNEN</h3>
                    <p class="subtext">
                        Basierend auf dem Niveau und der Lerngeschwindigkeit des Teilnehmers werden die BE-Dozenten den Teilnehmer befähigen, 
                        proaktiv an seiner Sprachentwicklung innerhalb der Online-Sitzungen und darüber hinaus durch Hausaufgaben und 
                        konstruktives Feedback zu arbeiten.
                    </p>
                  </div>
                </div>
                <div class="info">
                  ...
                  <div>
                    <h3>FÖRDERUNG KOMMUNIKATIVER FÄHIGKEITEN</h3>
                    <p class="subtext">
                        Teilnehmer und Dozent nutzen das Berndt Education Learning System, um durch angepasstes Training in der Lernsprache 
                        leicht und sicher zu kommunizieren.
                    </p>
                  </div>
                </div>
                <div class="info">
                  ...
                  <div>
                    <h3>FEEDBACK FÜR ERFOLG</h3>
                    <p class="subtext">
                        Die Dozenten geben online konstruktives Feedback und überwachen die Anwendung der Sprache, um den 
                ...
                <div class="info">
                  ...
                  <div>
                    ...
                    <p class="subtext">
                        Die Teilnehmer lernen über die BE-Kurse hinaus unabhängig vom BE-Dozenten mit den zur Verfügung gestellten 
                        Materialien und erzielen so einen maximalen Lernerfolg.
                    </p>
                  </div>
                </div>
            </div>
