...
<svelte:head>
    ...
    <main>
        ...
        <section class="sec-1">
            ...
            <div class="landing-page-info">
                ...
                <a id="redirect" href="/en">
                    <img id="main-logo" src="./img/icons/Wordpress Transparent.png" alt="Main Logo">
    ...
    .loader {
        ...
        border-top: 16px solid #d7b28e; /* Blue */
        border-radius: 50%;
        width: 120px;
        height: 120px;
