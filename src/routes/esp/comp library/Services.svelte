...
<div class="plan">
    <div class="inner">
        ...
        <br>
        <p class="info">- Selección de curso y universidad/colegio</p>
        <p class="info">- Work experience</p>
        <p class="info">- Experiencia de trabajo</p>
        <p class="info">- Preparación para las pruebas de admisión</p>
        ...
        <ul class="features">
            ...
            <li>
                ...
                <span><strong>UCAS</strong> Comprobación de la solicitud</span>
            </li>
        </ul>
        <div class="action">
        <a class="button" href="/esp/contact">
            Contacto
        </a>
        </div>
    </div>
...
<div class="plan">
    <div class="inner">
        ...
        <p class="info">- Preparación para las pruebas de admisión</p>
        <p class="info">- Solicitud de becas</p>
        <p class="info">- Comprobación de las solicitudes UCAS, que incluye el informe del tutor, la declaración 
