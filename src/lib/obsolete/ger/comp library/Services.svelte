...
<div class="plan">
    <div class="inner">
        ...
        <br>
        <p class="info">- Wahl des Studiengangs und der Universität/Hochschule</p>
        <p class="info">- Berufserfahrung</p>
        <p class="info">- Vorbereitung auf das Vorstellungsgespräch</p>
        <p class="info">- Vorbereitung auf den Zulassungstest</p>
        ...
        <ul class="features">
            ...
            <li>
                ...
                <span><strong>UCAS</strong> Bewerbungsprüfung</span>
            </li>
        </ul>
        <div class="action">
        <a class="button" href="/ger/contact">
...
<div class="plan">
    <div class="inner">
        ...
        <p class="info">
          ...
          die auf jeden Studenten zugeschnitten ist.
        </p>
        <br>
        <p class="info">- Wahl des Studiengangs und der Universität/Hochschule</p>
        <p class="info">- Berufserfahrung</p>
...
<div class="plan">
    <div class="inner">
        ...
        <p class="info">- Vorbereitung auf den Zulassungstest</p>
        <p class="info">- Bewerbung um ein Stipendium</p>
        <p class="info">- UCAS-Bewerbungscheck, der Ratschläge umfasst zu dem 
          Tutorbericht, der persönlichen Erklärung, zusätzlichen Bereichen wie 
...
.plan:nth-child(1) > .inner {
    background-color: #e9d9bd;
}

.plan:nth-child(2) > .inner {
    background-color: #e8ecf0;
}

.plan:nth-child(3) > .inner {
