                    ...
                    <div class="block">
                        <div>
                            <ul class="infos">
                                ...
                                <li>
                                    <p>
                                       Lernen Sie {lang} von zu Hause aus 
                                       über Zoom mit qualifizierten Dozenten und einem ansprechenden Lernsystem.
                                    </p>
                                </li>
                                <li>Kleine Gruppen</li>
                                <li>4 Mal pro Woche</li>
                                <li>Von Montag bis Donnerstag</li>
                                    <!-- <li>
                                        <div class="time">
                                            <div>
                                                <p>
