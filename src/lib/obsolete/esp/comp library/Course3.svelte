                        ...
                        <div class="block">
                            <div>
                                <ul class="infos">
                                    ...
                                    <li>
                                        <p>
                                            Aprenda {lang}  desde casa a través de Zoom con 
                                            y un atractivo sistema de aprendizaje. 
                                        </p>
                                    </li>
                                    <li>Grupos reducidos</li>
                                    <li>4 veces por semana</li>
                                    ...
                                    <li>
                                        <button class="button" style="vertical-align:middle"><a href="/esp/contact"><span>Join Now</span></a></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
